 function Result = AlgoRangeMapping(Num)
...
%     % Computing constants (Previous 3-region error correction equations)
%     if(m_2nd3rdMSBs == 0)                               % Region 3
%         if(m_2MSBs == 0)
%             const =  floor(((2-log2(5)) + (log2(1+0.5)-0.5) + 0.5*-0.003606310946431)*2^nr_MSBs_const + 0.5) / 2^nr_MSBs_const; 
%         elseif(m_2MSBs == 0.25)
%             const =  floor(((2-log2(4)) + (log2(1+0.5)-0.5) + 0.5*-0.003606310946431)*2^nr_MSBs_const + 0.5) / 2^nr_MSBs_const;
%         elseif(m_2MSBs == 0.5)
%             const =  floor(((2-log2(3.5)) + (log2(1+0.5)-0.5) + 0.5*-0.003606310946431)*2^nr_MSBs_const + 0.5) / 2^nr_MSBs_const;
%         elseif(m_2MSBs == 0.75)
%             const =  floor(((2-log2(3)) + (log2(1+0.5)-0.5) + 0.5*-0.003606310946431)*2^nr_MSBs_const + 0.5) / 2^nr_MSBs_const;
%         else
%             
%             fprintf('ERROR! No constant is selected for 3rd region! \n');
%             
%         end
%     elseif(m_2nd3rdMSBs == 2)                           % Region 1
%         if(m_2MSBs == 0)
...
%             
%         end
%     elseif(m_2nd3rdMSBs == 3)                           % Region 2
%         if(m_2MSBs == 0)
%             const =  floor(((2-log2(5)) + (log2(1+0.375)-0.375) + 0.5*0.001639713401399 - 0.00029)*2^nr_MSBs_const + 0.5) / 2^nr_MSBs_const; 
%         elseif(m_2MSBs == 0.25)
%             const =  floor(((2-log2(4)) + (log2(1+0.375)-0.375) + 0.5*0.001639713401399 - 0.00029)*2^nr_MSBs_const + 0.5) / 2^nr_MSBs_const;
%         elseif(m_2MSBs == 0.5)
%             const =  floor(((2-log2(3.5)) + (log2(1+0.375)-0.375) + 0.5*0.001639713401399 - 0.00029)*2^nr_MSBs_const + 0.5) / 2^nr_MSBs_const;
%         elseif(m_2MSBs == 0.75)
%             const =  floor(((2-log2(3)) + (log2(1+0.375)-0.375) + 0.5*0.001639713401399 - 0.00029)*2^nr_MSBs_const + 0.5) / 2^nr_MSBs_const;
%         else
%             
...
%     % Determining inputs to adders (Previous 3-region error correction equations)
%     if(m_2nd3rdMSBs == 2)
%         m_Corrected = m + 2^-3*x + const; 
%     elseif(m_2nd3rdMSBs == 3)
%         m_Corrected = m + const;
%     elseif(m_2nd3rdMSBs == 0)
%         m_Corrected = m + const;
%     else

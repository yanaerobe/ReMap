function ReCheckAlgo
    ...
    FileName = 'ReCheckAlgo Result.txt';
    tic;
    for Multiplier = 0 : 2^Power - 1
        ...
        for i = 1 : 2^Array
            ...
            Approx(i) = AlgoReMapping_fit(Num(i));           %CHANGE ALGORITHM'S FUNCTION HERE!
        end
        if Count == 256
            Count = 0;
        end
